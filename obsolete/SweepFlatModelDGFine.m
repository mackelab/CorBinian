...
basename='~/CopyMPI/MaxEnt/Data/SweepFlatModelDGFine';
    load([basename,'/allstuff']);
    
end


dims=[4,5,6,8,10,15,20,25,50,75,100]; %use Ising model with 2, 5, 10, 15 dimensions
means=[.01:.01:.5]; %try out means 0.01, .1, .5
rhos=[.005:.005:.25]; %take pairwise correlation 0, .1, .5
